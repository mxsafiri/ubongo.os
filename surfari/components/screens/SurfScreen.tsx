    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: `0 -8px 48px rgba(0,0,0,0.6), 0 0 0 1px ${tierColor}12`,
        }}
      >
        {/* Tier accent bar */}
        ...
        <div className="px-5 pt-4 pb-5">
          ...
          <div className="grid grid-cols-2 gap-2.5 mb-4">
            ...
            <StatTile
              ...
              value={isClaimed ? `@${zone.owner_handle}` : 'Unclaimed'}
          ...
          <motion.button
            ...
            style={{
              ...
              boxShadow: '0 0 0 1px rgba(0,212,255,0.3), 0 8px 32px rgba(0,212,255,0.2)',
            }}
...
function StatTile({ icon, label, value, color }: {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5" style={{ color, opacity: 0.8 }}>
        {icon}
