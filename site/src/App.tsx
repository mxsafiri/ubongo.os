      ...
      >
        <div className="max-w-5xl mx-auto px-6 h-12 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[9px] tracking-widest" style={{ color: 'var(--accent)', opacity: 0.5 }}>v0.5.17</span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg">
          ...
          <Reveal delay={0.1} rotate={-2}>
            <div className="card">
              ...
              <div className="text-[9px] font-mono mb-4" style={{ color: 'var(--text-faint)' }}>v0.5.17 &middot; ~145 MB</div>
              <a href="https://github.com/mxsafiri/ubongo.os/releases/latest/download/ubongo_0.5.17_aarch64.dmg" className="btn-primary w-full px-4 py-2.5 text-[11px] tracking-wider">
